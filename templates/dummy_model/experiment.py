...
def render_molecule(xyz_path, out_path):
    """Renders a molecule from an xyz file and saves it as a png image
    ...
    # Plot the molecule
    plot_atoms(mol, ax, rotation=('45x,0y,0z'), scale=0.5, radii=0.8)
